...
class PlaidConnection{
    ...
    typealias successHandler = (_ response : [String : Any])  -> Any
    ...
    func aggregateAccounts(response: [String: Any]) -> [Account]{
        return self.proccessor.aggregateAccounts(response: response)
    }
